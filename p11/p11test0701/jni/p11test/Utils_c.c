...
* @return    self object
*/
CK_RV UtilsTimeAdded(UtilscTimePtr tt1, UtilscTimePtr tt2) 
{
	if((tt1==NULL)||(tt1==NULL))
	{
...
* @return    self object
*/
CK_RV UtilsTimeSubstracted(UtilscTimePtr tt1, UtilscTimePtr tt2) 
{
...
*/
CK_RV Utilsprint(UtilscTimePtr getted_time, const char* tag, unsigned int looptime)
{
