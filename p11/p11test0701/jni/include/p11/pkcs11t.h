...
#else
typedef CK_UINT          CK_OBJECT_CLASS;
#endif
...
#else
typedef CK_UINT          CK_CERTIFICATE_TYPE;
#endif
...
#else
typedef CK_UINT  	    CK_ATTRIBUTE_TYPE;
#endif
...
#else
typedef CK_UINT          CK_MECHANISM_TYPE;
#endif
...
#else
  CK_UINT          ulParameterLen;  /* in bytes */
#endif
} CK_MECHANISM;
