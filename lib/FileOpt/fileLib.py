...
class FileUtils():
    ...
    # 复制路径下的所有文件到指定目录
    def exec_dir(self, src_path, dst_path):
        if os.path.isfile(src_path):
            ...
            for file_sub in os.listdir(src_path):
                self.exec_dir(src_path + "/" + file_sub, dst_path)
        else:
            print "error."
...
if __name__ == '__main__':
    ...
    """verify the get files under root director and subdirectory."""
    for file in fu.get_files("./", '.py'):
        print file
