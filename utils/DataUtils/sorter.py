...
from CustomLibrary.utils.DataUtils.data_utils import *


# 平均时间复杂度为O(nlogn)的算法有：归并排序，堆排序和快速排序
# 平均时间复杂度均为O(n^2)的算法：插入排序，选择排序和冒泡排序
...
if __name__ == '__main__':
    ...
    bubble_sort_r(array_tmp)
    print "bubble_sort: ", array_tmp

    insertion_sort_r(array_tmp)
