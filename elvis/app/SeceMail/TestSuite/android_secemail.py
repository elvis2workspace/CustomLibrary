...
import DriverInfo
from tools import check_appium
...
class SeceMailTest(unittest.TestCase):
    def setUp(self):
        try:
            ...
            print "Take attention please, check and initial test environment failed!"  
        else:
            pass
...
#         self.driver = webdriver.Remote('http://127.0.0.1:4723/wd/hub', desired_caps)
    ...
    def suites(self):
        ...
        suite.addTest(SeceMailTest("test_add_account"))
        return suite 
...
#         self.assertEqual('每锟斤拷15锟斤拷锟斤拷', textview.text().decode('utf-8'))
